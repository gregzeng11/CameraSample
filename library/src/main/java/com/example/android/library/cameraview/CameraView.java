...
public class CameraView extends FrameLayout {
    ...
    public static final int FACING_BACK = TConstants.FACING_BACK;
    public static final int FACING_FRONT = TConstants.FACING_FRONT;
    ...
    public static final int FLASH_OFF = TConstants.FLASH_OFF;
    public static final int FLASH_ON = TConstants.FLASH_ON;
    public static final int FLASH_TORCH = TConstants.FLASH_TORCH;//手电筒状态
    public static final int FLASH_AUTO = TConstants.FLASH_AUTO;
    public static final int FLASH_RED_EYE = TConstants.FLASH_RED_EYE;
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (aspectRatio != null) {
            ...
            setAspectRatio(TConstants.DEFAULT_ASPECT_RATIO);//默认宽高比是16:9
        }
        setAutoFocus(a.getBoolean(R.styleable.CameraView_autoFocus, true));//默认自动对焦模式
        setFlash(a.getInt(R.styleable.CameraView_flash, TConstants.FLASH_OFF));//默认关闭闪光灯
        a.recycle();
