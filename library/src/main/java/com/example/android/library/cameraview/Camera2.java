...
class Camera2 extends CameraViewImpl {
    ...
    static {
        INTERNAL_FACINGS.put(TConstants.FACING_BACK, CameraCharacteristics.LENS_FACING_BACK);
        INTERNAL_FACINGS.put(TConstants.FACING_FRONT, CameraCharacteristics.LENS_FACING_FRONT);
    }
    ...
    private AspectRatio mAspectRatio = TConstants.DEFAULT_ASPECT_RATIO;
    ...
    private boolean chooseCamera() {
        try {
            ...
            mFacing = TConstants.FACING_BACK;
            return true;
        } catch (CameraAccessException e) {
    ...
    private void chooseAspectRatio() {
        if (!mPreviewSizes.ratios().contains(mAspectRatio)) {
            if (mPreviewSizes.ratios().contains(TConstants.DEFAULT_ASPECT_RATIO)) {//首先看16:9是否支持
                ...
                mAspectRatio = TConstants.SECOND_ASPECT_RATIO;
    ...
    private void captureStillPicture() {
        try {
            ...
            captureRequestBuilder.set(CaptureRequest.JPEG_ORIENTATION,
                    (sensorOrientation + mDisplayOrientation * (mFacing == TConstants.FACING_FRONT ? 1 : -1) + 360) % 360);
